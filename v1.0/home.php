   ...
   <body>
     ...
     <header id="header" class="header header-classic">
                 ...
                 <ul class="navbar-nav ml-auto">
                   ...
                   <li class="nav-item <?php if($_GET["p"] == 5) echo "active"; ?>">
                    ...
                    <?php
                        ...
                        {
                          echo '<a href="register.php" class="ticket-btn btn">Register</a>';
                        }
                     ?>
      ...
      <video class="banner-item overlay" autoplay muted loop id="myVideo" style="position:fixed; left:0; right: 0; bottom:0; top:75px; width: 100vw; height: 100vh; overflow: hidden; z-index:-9999999; object-fit: cover;">
       <source src="images/video/Yorfestrender3.mp4" type="video/mp4">
               ...
               <div class="col-lg-8">
                  <div class="">
                     <div class="outcome-content ts-exp-content">
                        ...
                        <p>
                           Acara tahunan para pegiat organik di Indonesia yg, YORFest adalah kumpulan komunitas anak muda yang peduli dengan pertanian, perkebunan & peternakan, bisnis yang berhubungan dengan pendayagunaan sistem organik yang alami.<br>
               ...
               <div class="col-lg-6 no-padding align-self-center wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="500ms">
                  <div class="ts-exp-wrap">
                     <div class="ts-exp-content">
                        ...
                        <p>
                           Saatnya kita untuk bersinergi, apakah kamu pembicara, peserta dan peminat? Mari kita bangun jaringan  dengan berbincang di Organic Networking Space.
                        </p>
