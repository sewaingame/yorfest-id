                  ...
                  <div class="col-lg-4 offset-lg-1">
                     <div class="hero-form-content row ml-md-0 ml-1 mr-md-0 mr-1">
                        ...
                        <div class="col-12 text-left">
                           ...
                           <label id="v-name" for="name" style="color:#FF6C6C; font-size:12px; display:none;">Email is not valid</label>
                        </div>
                        <div class="col-12 text-left">
                        ...
                        <div class="col-12 text-center mt-3"  id="v-login" style="display:none;">
                          <label for="name" style="color:#FF6C6C; font-size:12px;" id="v-login-m"> Wrong email or password.</label>
                        </div>
